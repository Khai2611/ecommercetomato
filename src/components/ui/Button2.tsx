    ...
    ],
    {
        variants: {
            ...
            modifier: {
                ...
                gradient:
                    'bg-gradient-to-br from-Very_dark_blue to-Dark_grayish_blue',
                sideLink:
                    'justify-start text-Very_dark_blue hover:text-Dark_grayish_blue',
                headerLink: 'text-Dark_grayish_blue hover:text-Grayish_blue',
                footerLink:
                    'py-3 px-4 text-Grayish_blue hover:text-Dark_grayish_blue',
                socialLink:
        ...
        compoundVariants: [
            {
                ...
                modifier: 'outline',
                className:
                    'p-8 ring-2 focus-visible:outline-offset-4 focus-visible:ring-current',
            },
            {
                variant: 'default',
                modifier: 'outline',
            ...
            },
            {
                ...
                modifier: 'sideLink',
                className:
                    'py-4 px-8 focus-visible:shadow focus-visible:outline-offset-0',
            },
            {
                variant: 'link',
                selected: true,
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    (
        ...
        if (props.href) {
            return (
                <Link
                    //added to, which didnt exist prior
                    to={'/shop'}
                    href={props.href}
                    onPointerDown={onPointerDown}
                    ref={ref as ForwardedRef<HTMLAnchorElement>}
                    className={cm(
                        hasRipple && 'overflow-hidden',
